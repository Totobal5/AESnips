...
//Create Snips
idle_snip = new Snip(red_cowboy_full, .5, 0,  2,   SnipEnd.replay);
draw_snip = new Snip(red_cowboy_full,  1, 3,  6, SnipEnd.stopHead);
fire_snip = new Snip(red_cowboy_full,  1, 7, 10, SnipEnd.stopTail);
holster_snip = new Snip(red_cowboy_full, 1, 11, 19,  SnipEnd.stop);
